...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v1.5.4 | 2026-03-12 | 修复 issue #2: 增强中文字体加载逻辑，添加更多字体源和系统字体搜索 |
| v1.5.3 | 2026-03-12 | 修复 issue #2: v1.5.2 版本界面中文仍然加载不出来 |
| v1.5.2 | 2026-03-12 | 修复 issue #1: Windows 版本闪退和中文乱码问题 |
| v1.5.1 | 2026-03-12 | 修复构建流程中字体下载链接错误 |
| v1.5.0 | 2026-03-12 | 修复 Windows 版本闪退和中文乱码问题 |
| v1.4.0 | 2026-03-12 | 优化构建配置和文档更新，规范发布文件命名 |
| v1.3.0 | 2026-03-12 | 修复 GitHub Actions release 步骤的 404 错误 |
| v1.2.0 | 2026-03-12 | 优化游戏画面和特效 |
| v1.1.0 | 2026-03-12 | 添加 macOS 构建支持 |
| v1.0.0 | 2026-03-11 | 初始发布版本 |
